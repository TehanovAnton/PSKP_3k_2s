...
const sequelize = new Sequelize('pskp', 'anton', 'ewqqwe',
...
let http_handler = (req,res)=>
{
    ...
    // if(pathname.search('\/api\/faculties\/[%-я]+')!=(-1)){
    ...
    //     }); 
    // }
    // else if(pathname.search('\/api\/pulpits\/[%-я]+')!=(-1)){
    //     let p = url.parse(req.url,true);
    //     let r =decodeURI(p.pathname).split('/');
    //     let o = r[3];
    ...
    //     });
    // }
    // else if(pathname.search('\/api\/subjects\/[%-я]+')!=(-1)){
    //     let p = url.parse(req.url,true);
    //     let r =decodeURI(p.pathname).split('/');
    //     let o = r[3];
    ...
    //         });
    // }
    // else if(pathname.search('\/api\/auditoriumstypes\/[%-я]+')!=(-1)){
    //     let p = url.parse(req.url,true);
    //     let r =decodeURI(p.pathname).split('/');
    //     let o = r[3];
    ...
    //     });
    // }
    // else if(pathname.search('\/api\/auditoriums\/[%-я]+')!=(-1)){
    //     let p = url.parse(req.url,true);
    //     let r =decodeURI(p.pathname).split('/');
    //     let o = r[3];
